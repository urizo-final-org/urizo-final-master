...
The earlier v0.6 handoff remains preserved in the original handoff package. Master v0.7 preserves the pre-publication checkpoint; v0.8 records the published remote and teammate-onboarding checkpoint. Historical documents are not overwritten.
