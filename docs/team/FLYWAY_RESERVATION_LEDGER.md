...
| `20260911095234061` | `PR_OPEN` | `axms-template-banner-layouts` | `add_cms_template_hero_images` | `tmdwns0531` | `2026-10-11T09:52:34Z` | [Backend #97](https://github.com/urizo-final-org/urizo-final-backend/pull/97) | `20260819165652` |

| `20260911104548836` | `PR_OPEN` | `axms-template-banner-layouts` | `add_cms_template_image_captions` | `tmdwns0531` | `2026-10-11T10:45:48Z` | [Backend #97](https://github.com/urizo-final-org/urizo-final-backend/pull/97) | `20260911095234061` |
