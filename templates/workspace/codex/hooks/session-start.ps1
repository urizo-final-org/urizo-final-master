...
try {
    ...
    [void]$builder.AppendLine('- Merge rule: tmdwns0531은 dev PR의 Ruleset 직접 병합 예외 Actor다. 명시적 병합 요청과 Base·Head SHA·Mergeable 확인 후 필수 리뷰로만 막히면 --merge --admin을 사용할 수 있다.')
